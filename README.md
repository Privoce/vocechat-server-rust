...
| ---------- | ----------------------------------- | --------------------------------------------------------- | ------- | --------------------------------------------------- |
| Server     | Rust                                | [vocechat-server](https://github.com/privoce/vocechat-server-rust) | GPLv3   | Server Supports platforms: Linux, Windows, Arm32/64 |
| Server image | Docker, Shell                             | [vocechat-docker]([Creative Commons Attribution-NonCommercial 4.0 International](https://hub.docker.com/r/privoce/vocechat-server/tags)) | GPLv3     | Client supports Android and IOS platforms           |
